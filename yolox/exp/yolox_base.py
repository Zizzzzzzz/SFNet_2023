...
class Exp(BaseExp):
    ...
    def preprocess(self, inputs, sifs, targets, tsize):
        ...
        if scale_x != 1 or scale_y != 1:
            ...
            sifs = nn.functional.interpolate(
                sifs, size=tsize, mode="bilinear", align_corners=False
            )
            targets[..., 1::2] = targets[..., 1::2] * scale_x
            targets[..., 2::2] = targets[..., 2::2] * scale_y
        return inputs, sifs, targets
